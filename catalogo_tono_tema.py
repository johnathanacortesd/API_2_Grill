...
CRITERIOS_TONO = {
 "Aspectual estricto (recomendado)": "El tono mide SOLO lo que se dice de la entidad, de su vocero o de sus funcionarios.\n- Positivo: la entidad o su vocero es sujeto de un hecho favorable (obra entregada, avance,\n  beneficio para la comunidad, programa, reconocimiento, cifra buena, declaracion que los deja bien).\n- Negativo: existe critica, reclamo, sancion, denuncia o evaluacion negativa DIRIGIDA a la entidad,\n  a su administracion o a sus funcionarios.\n- LA PREGUNTA CLAVE antes de escribir Negativo: ¿de quien habla la nota? Si la entidad o su vocero\n  NO aparece como responsable, señalado o protagonista de la critica, el tono es Neutro. Los temas\n  tristes o graves NO son Negativo para la entidad: muertes, suicidio, delincuencia, desempleo,\n  pobreza, inundaciones, obras inconclusas de terceros, quejas contra otros. Una nota puede\n  mencionar a la entidad y seguir siendo Neutro (la entidad estudia el problema, participa en un\n  foro, firma una alianza o es una voz mas entre varias).\n- INFORMES, ESTUDIOS E INVESTIGACIONES: si la entidad, un alias o su vocero elabora, lidera, presenta, publica, coordina, financia o participa explícitamente en un informe, estudio, investigación, encuesta, columna de opinión, entrevista, foro, congreso, evento, alianza o intervención pública, el tono es Positivo. También es Positivo si aparece como colaboradora, coautora, fuente experta o participante identificable. No se exige que sea la única autora. Solo será Neutro si la nota únicamente la menciona de paso, sin acción, aporte ni intervención atribuible.\\n- La gravedad del asunto tratado no cambia esta regla: un estudio de desempleo o salud mental hecho o presentado por la entidad es Positivo cuando la entidad participa activamente.\\n- SI LA ENTIDAD ACTUA FRENTE AL PROBLEMA: si ayuda, dona, articula apoyos o propone una solución ante un hecho grave, también es Positivo.\\n- TRAGEDIA CON EXPERTO DE LA CASA: si la nota es una tragedia (muerte, accidente fatal) y el experto, docente o investigador de la entidad SOLO aparece citado como fuente u opinando, sin que la entidad actúe frente al problema, el tono es Neutro, no Positivo.\\n- Neutro: la marca solo aparece mencionada, sin acción, aporte ni intervención atribuible.\\n\\n- EVENTOS Y LOGROS PROPIOS TAMBIÉN SON POSITIVO: el congreso, conferencia, seminario, feria o competencia que organiza la marca, la acreditación, el premio, el ranking o el reconocimiento que recibe, y los logros de sus estudiantes, equipos o sedes, son Positivo.\\n\\n- Participar, asistir o ser mencionado no es Positivo si la marca solo aparece de paso en un foro ajeno o en el informe de un tercero.\\n\\nPRIORIDAD: si la marca es autora, colaboradora, coautora, fuente experta o participante identificable en la acción, el informe, estudio, investigación, columna de opinión, intervención, alianza o evento, es Positivo. Ante duda entre Negativo y Neutro, elige Neutro.",
...
EJEMPLOS_TEMA = [
 ...
 {
  "titulo": "La entidad puso en marcha el programa de becas para 3.000 jóvenes del departamento",
  "sub_tema": "Programa de becas para jóvenes",
  "tono": "Positivo"
 },
 {
  "titulo": "La entidad anunció una inversión de $20 mil millones para vías terciarias",
  "sub_tema": "Inversión en vías terciarias",
  "tono": "Positivo"
 },
 {
  "titulo": "La entidad inauguró la nueva sede y entregó dotación a 12 colegios",
  "sub_tema": "Inauguración de sede y dotación",
  "tono": "Positivo"
 },
 {
  "titulo": "El programa de Medicina de la Universidad Simón Bolívar realizará la I Conferencia Internacional Caribe de Educación Médica",
  "sub_tema": "Conferencia internacional de educación médica",
  "tono": "Positivo"
 },
 {
  "titulo": "Estudiantes de la Universidad Simón Bolívar ganaron el concurso nacional de robótica",
  "sub_tema": "Estudiantes ganan concurso de robótica",
  "tono": "Positivo"
 },
 {
  "titulo": "La Universidad Simón Bolívar recibió la acreditación de alta calidad por ocho años",
  "sub_tema": "Acreditación de alta calidad",
  "tono": "Positivo"
 },
 {
  "titulo": "La Universidad Simón Bolívar participará en el foro nacional de educación superior",
  "sub_tema": "Participación en foro de educación",
  "tono": "Neutro"
 },
 {
  "titulo": "El informe de la entidad advierte que creció el desempleo juvenil",
  "sub_tema": "Informe sobre desempleo juvenil",
  "tono": "Neutro"
 },
 {
